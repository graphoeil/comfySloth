...
/* Le composant StripeCheckout ne communique pas avec @stripe
pour des raisons de sécurité, nous passons par les fonctions
netlify contenues dans le dossier functions (hello.js) */

/* loadStripe, permet de se connecter à stripe, retourne 
une promesse que nous passons en props au composant Elements */
...
const CheckoutForm = () => {
	...
	// Invocation de stripe
	const stripe = useStripe();
	const elements = useElements();

	// CardStyles, à injecter en props dans CardElement
	const cardStyles = {
		style:{
			base:{
				color:'#32325d',
	...
	const createPaymentIntent = async() => {
		...
		// vers ../functions/create-payment-intent.js
		try {
...
// Styled components
/* Les styles proviennent directement de stripe
